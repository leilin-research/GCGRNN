...
val_error, predic_res, test_Y, test_error = gcnn_ddgf(hidden_num_layer, node_num, feature_in, horizon, learning_rate, decay, batchsize, keep, early_stop_th, training_epochs, X_training, Y_training, X_val, Y_val, X_test, Y_test, scaler)
